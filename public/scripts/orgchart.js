...
///////////////////////////////////////
/*document.getElementsByTagName("BODY")[0].onpageshow = function() {myFunction1()};
...
sensor.start();
/*
sensor.addEventListener('activate', function(){
  console.log('Ready to report readings');
});
...
//document.querySelector('body').onload = function() {FAmbientLightSensor()};

//function FAmbientLightSensor(){
 /*
  const sensor = new AmbientLightSensor();
  sensor.start();
