...
OrgChart.prototype.load = function(t) {
    ...
    this.node = this.obj.getNode(t), this.wrapperElement = document.getElementById("bgEditForm"), this.wrapperElement && this.obj.element.removeChild(this.wrapperElement),
